...
class LimiteDeteccaoVM:
    def __init__(self, master, service, variaveis):
        ...
        self.limitedeteccao_view.pack(fill="x", padx=10, pady=10)
        self.limitedeteccao_view.botao_limite.configure(command=self.calcula_resultado_limite)
    ...
    def habilita_limite(self, arquivo_padrao, c_padrao):
        ...
        self.limitedeteccao_view.botao_limite.configure(state="normal")
